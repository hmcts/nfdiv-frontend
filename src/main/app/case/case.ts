...
export const formFieldsToCaseMapping: Partial<Record<keyof Case, keyof CaseData>> = {
  ...
  isYourAddressInternational: 'applicant1HomeAddressIsInternational',
  isTheirAddressInternational: 'applicant2HomeAddressIsInternational',
  ...
  respondentEmailAddress: 'applicant2EmailAddress',
