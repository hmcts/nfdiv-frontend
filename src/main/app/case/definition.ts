...
export const SYSTEM_MIGRATE_CASE_WITH_COE_GENERATION = 'system-migrate-case-and-generate-coe';
...
export const SYSTEM_NOTIFY_JOINT_APPLICANT_CAN_SWITCH_TO_SOLE = 'system-notify-joint-applicant-switch-to-sole';
