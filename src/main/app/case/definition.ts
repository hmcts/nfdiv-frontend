...
export interface Application {
  applicant1HasMarriageBroken: MarriageBroken[];
  applicant1HasCivilPartnershipBroken: CivilPartnershipBroken[];
...
export const enum CivilPartnershipBroken {
  CIVIL_PARTNERSHIP_BROKEN = 'civilPartnershipBroken',
}
...
export const enum MarriageBroken {
  MARRIAGE_BROKEN = 'marriageBroken',
}
