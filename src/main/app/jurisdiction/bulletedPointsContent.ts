...
export const connectionBulletPointsTextForJointApplications = (connections: JurisdictionConnections[]): string[] => {
  const connectionBulletPoints = {
    [JurisdictionConnections.APP_1_APP_2_RESIDENT]:
      'either one or both applicants are habitually resident in England and Wales',
    [JurisdictionConnections.APP_1_APP_2_LAST_RESIDENT]:
      'the applicants were last habitually resident in England and Wales and one of them still resides there',
    [JurisdictionConnections.APP_1_RESIDENT_TWELVE_MONTHS]:
      'one of the applicants resides in England and Wales and has resided there for at least a year immediately prior to the presentation of the application',
    [JurisdictionConnections.APP_1_RESIDENT_SIX_MONTHS]:
      'the applicants are domiciled and habitually resident in England and Wales and have resided there for at least six months immediately prior to the application',
    [JurisdictionConnections.APP_1_APP_2_DOMICILED]: 'the applicants are domiciled in England and Wales',
    [JurisdictionConnections.RESIDUAL_JURISDICTION]:
      'the applicants are registered as civil partners of each other in England or Wales or, in the case of a same sex couple,' +
