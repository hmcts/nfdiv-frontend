...
export const proxyList: {
...
}[] = [
  {
    ...
    path: (req: AppRequest): string => findDocumentAndGetPath(req.session.userCase, DocumentType.APPLICATION),
  },
  {
  ...
  },
  {
    ...
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.DEEMED_AS_SERVICE_GRANTED),
  },
  {
    endpoints: ['/downloads/certificate-of-dispense-with-service'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.DISPENSE_WITH_SERVICE_GRANTED),
  },
  {
    endpoints: ['/downloads/certificate-of-entitlement'],
    path: (req: AppRequest): string => getPath(req.session.userCase?.coCertificateOfEntitlementDocument),
  },
  {
    endpoints: ['/downloads/conditional-order-granted'],
    path: (req: AppRequest): string => getPath(req.session.userCase?.coConditionalOrderGrantedDocument),
  },
  {
    endpoints: ['/downloads/conditional-order-refusal'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.CONDITIONAL_ORDER_REFUSAL),
  },
  {
    endpoints: ['/downloads/conditional-order-answers'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.CONDITIONAL_ORDER_ANSWERS),
  },
  {
    endpoints: ['/downloads/final-order-granted'],
    path: (req: AppRequest): string => findDocumentAndGetPath(req.session.userCase, DocumentType.FINAL_ORDER_GRANTED),
  },
  {
    endpoints: ['/downloads/deemed-service-refused'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.DEEMED_SERVICE_REFUSED),
  },
  {
    endpoints: ['/downloads/dispense-with-service-refused'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.DISPENSE_WITH_SERVICE_REFUSED),
  },
  {
    endpoints: ['/downloads/bailiff-service-refused'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.BAILIFF_SERVICE_REFUSED),
  },
  {
  ...
  },
  {
    ...
    path: (req: AppRequest): string => findDocumentAndGetPath(req.session.userCase, DocumentType.BAILIFF_SERVICE),
  },
  {
    endpoints: ['/downloads/conditional-order-application'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.CONDITIONAL_ORDER_APPLICATION),
  },
  {
    endpoints: ['/downloads/final-order-application'],
    path: (req: AppRequest): string =>
      findDocumentAndGetPath(req.session.userCase, DocumentType.FINAL_ORDER_APPLICATION),
  },
  {
    endpoints: ['/downloads/final-order-granted'],
    path: (req: AppRequest): string => findDocumentAndGetPath(req.session.userCase, DocumentType.FINAL_ORDER_GRANTED),
...
const findDocumentAndGetPath = (userCase: CaseWithId, documentType: DocumentType): string => {
  return getPath(userCase?.documentsGenerated.find(doc => doc.value.documentType === documentType)?.value);
};

const getPath = (document: DivorceDocument | undefined): string => {
