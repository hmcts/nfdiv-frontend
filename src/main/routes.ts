...
export class Routes {
  public enableFor(app: Application): void {
    ...
    app.get(CERTIFICATE_URL, errorHandler(app.locals.container.cradle.certificateGetController.get));
    app.post(CERTIFICATE_URL, errorHandler(app.locals.container.cradle.certificatePostController.post));
    app.get(NO_CERTIFICATE_URL, errorHandler(app.locals.container.cradle.noCertificateGetController.get));
