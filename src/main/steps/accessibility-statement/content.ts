...
const en = {
  ...
  statement: 'Accessibility statement for divorce',
...
const cy: typeof en = {
  ...
  statement: 'Datganiad hygyrchedd y gwasanaeth ysgaru',
  ...
  abilityNet: 'Mae gan <a href="https://mcmw.abilitynet.org.uk" class="govuk-link" target="_blank" aria-label="Bydd y ddolen hon yn agor mewn tab newydd ar gyfer AbilityNet">AbilityNet</a> gyngor ar sut i wneud eich dyfais yn haws i’w ddefnyddio os oes gennych anabledd.',
  ...
  issuesWithOtherDescription2: 'Nid yw rhai tudalennau’n cynnwys tagiau ARIA clir sy’n golygu na all darllenwyr sgrin na thagiau ARIA ddarllen y tudalennau.',
