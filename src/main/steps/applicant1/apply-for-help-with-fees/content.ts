...
const cy: typeof en = ({ isDivorce, isApplicant2 }) => ({
  ...
  sendEvidenceGuidanceLine1: 'Os ydych yn derbyn unrhyw fudd-dal sy’n eich gwneud yn gymwys i gael Help i Dalu Ffioedd, dylech gynnwys tystiolaeth o hynny pan fyddwch yn gwneud cais ar-lein am Help i Dalu Ffioedd.',
  sendEvidenceGuidanceLine2: `Os na allech gynnwys tystiolaeth o’ch budd-daliadau pan fyddwch yn gwneud cais ar-lein am Help i Dalu Ffioedd, rhaid i chi anfon eich tystiolaeth i’r llys pan fyddwch yn cyflwyno’r ${isDivorce ? 'cais hwn am ysgariad' : "cais hwn i ddod â'ch partneriaeth sifil i ben"}.`,
  sendEvidenceGuidanceLine3: `Byddwch yn cael cyfeirnod eich achos ar ôl i chi gyflwyno eich ${isDivorce ? 'cais am ysgariad' : "cais i ddod â'ch partneriaeth sifil i ben"}.`,
  sendEvidenceGuidanceLine4: `E-bostiwch eich tystiolaeth o'ch budd-daliadau, gan gynnwys cyfeirnod eich achos, i <a href="mailto:contactdivorce@justice.gov.uk">contactdivorce@justice.gov.uk</a>.`,
