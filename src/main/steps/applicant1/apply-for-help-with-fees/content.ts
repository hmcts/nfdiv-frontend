...
const en = ({ isDivorce, isApplicant2 }) => ({
  ...
  sendEvidenceGuidanceLine1:
    'If you receive any benefit that qualifies you for Help with Fees, you must include evidence of it when you apply online for Help with Fees.',
  sendEvidenceGuidanceLine2: `If you cannot include your benefits evidence when you apply online for Help with Fees, you must send your evidence to the court when you submit this ${
    isDivorce ? 'divorce application' : 'application to end your civil partnership'
  }.`,
  sendEvidenceGuidanceLine3: `You will get your case reference number after you submit your ${
    isDivorce ? 'divorce application' : 'application to end your civil partnership'
  }.`,
  sendEvidenceGuidanceLine4:
...
const cy: typeof en = ({ isDivorce, isApplicant2 }) => ({
  ...
  sendEvidenceGuidanceLine1:
    'Os ydych yn derbyn unrhyw fudd-dal sy’n eich gwneud yn gymwys i gael Help i Dalu Ffioedd, dylech gynnwys tystiolaeth o hynny pan fyddwch yn gwneud cais ar-lein am Help i Dalu Ffioedd.',
  sendEvidenceGuidanceLine2: `Os na allech gynnwys tystiolaeth o’ch budd-daliadau pan fyddwch yn gwneud cais ar-lein am Help i Dalu Ffioedd, rhaid i chi anfon eich tystiolaeth i’r llys pan fyddwch yn cyflwyno’r ${
    isDivorce ? 'cais hwn am ysgariad' : "cais hwn i ddod â'ch partneriaeth sifil i ben"
  }.`,
  sendEvidenceGuidanceLine3: `Byddwch yn cael cyfeirnod eich achos ar ôl i chi gyflwyno eich ${
