...
const en = ({ isDivorce, required, partner }) => ({
  title: `Why is your ${partner}'s legal  name different to how it is written on the ${isDivorce ? 'marriage' : 'civil partnership'} certificate?`,
  line1: `You must explain the reason for the difference, for example, your ${partner} changed their name when they ${isDivorce ? 'got married' : 'formed your civil partnership'}, or part of the legal name was not included in the ${isDivorce ? 'marriage' : 'civil partnership'} certificate.`,
  ...
  partOfNameNotIncluded: `Part of my ${partner}'s legal name was not included on the ${isDivorce ? 'marriage' : 'civil partnership'} certificate`,
  partOfNameAbbreviated: `Part of my ${partner}'s legal name is abbreviated on the ${isDivorce ? 'marriage' : 'civil partnership'} certificate`,
  legalNameSpelledDifferently: `The legal name is spelled differently on the ${isDivorce ? 'marriage' : 'civil partnership'} certificate`,
  other: 'Other',
  ...
  applicant1WhyNameDifferentOtherDetails: `If the difference is because your ${partner}'s legal name or name on the ${isDivorce ? 'marriage' : 'civil partnership'} certificate has a title, provide an explanation about the title on your name.`,
  anotherWay: 'Another way',
  anotherWayMoreDetails:
    `Provide details of when and how your ${partner} changed their name. You will be asked to upload a photo or scan of the documents that prove they changed their name later in this application, or you can post them in. If you do not have any documents, explain why here.`,
...
const cy = ({ isDivorce, required }) => ({
  ...
  changedAnotherWayDetails: `Os yw’r gwahaniaeth oherwydd bod eich enw cyfreithiol neu’r enw ar y dystysgrif ${isDivorce ? 'briodas' : 'partneriaeth sifil'} yn cynnwys teitl, darparwch esboniad am y teitl ar eich enw.`,
