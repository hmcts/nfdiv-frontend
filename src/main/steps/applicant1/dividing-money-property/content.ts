...
const en = ({ partner }: CommonContent) => ({
  ...
  agreeOnDividingAssetsDetails: `You can ask the court to make your agreement legally binding. This is known as applying for a ‘financial order by consent’. There is an additional fee of ${config.get(
    'fees.consentOrder'
  ...
  costs: `Applying to the court to make a ‘contested financial order’ is done separately, using another form. It costs an additional ${config.get(
    'fees.financialOrder'
  )}.`,
});
