...
const en = ({ isDivorce, required }) => ({
  ...
  yes: `Yes, I have my ${isDivorce ? 'marriage certificate' : 'civil partnership certificate'} with me`,
  no: `No, I do not have ${isDivorce ? 'marriage certificate' : 'civil partnership certificate'} with me`,
  errors: {
