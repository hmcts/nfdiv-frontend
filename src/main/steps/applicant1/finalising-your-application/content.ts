...
const en = ({ isDivorce, partner, userCase, isJointApplication }: CommonContent) => ({
  ...
  readMoreChangeToSole: {
    ...
    orderedList1FinalOrder: `<a class="govuk-link" href="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/952032/d36-eng.pdf"
    download="Download-Fill-Out-Application-For-Final-Order">Download and fill out an application for a final order</a>. (as a sole applicant)`,
    orderedList2CertificateOfService: `Give notice to your ${partner} that you are intending to apply for a final order as a sole applicant.
    You can do this by sending them a draft copy of the application by email or post. You will need to  <a class="govuk-link" href="https://www.gov.uk/government/publications/form-n215-certificate-of-service"
    download="Download-Fill-Out-Certificate-Of-Service">fill out a 'certificate of service'</a> form to prove to the court that you have given them notice.`,
    ...
    bulletPoint1: `The <a class="govuk-link" href="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/952032/d36-eng.pdf"
    download="Download-Fill-Out-Application-For-Final-Order">application for a final order</a> which proves that you have given notice to your ${partner} that you are intending to apply for a final order as a sole applicant.`,
    bulletPoint2: `The <a class="govuk-link" href="https://www.gov.uk/government/publications/form-n215-certificate-of-service"
    download="Download-Fill-Out-Certificate-Of-Service"> 'certificate of service'</a> which proves that you have given notice to your ${partner} that you are intending to apply for a final order as a sole applicant.`,
    postOrEmail:
