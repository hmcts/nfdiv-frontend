  ...
  fields: userCase => ({
    applicant1GenAppsEvidenceUploadedFiles: {
      ...
      validator: (value, formData) => {
        ...
        const selectedCannotUploadDocuments = !!formData.applicant1GenAppsCannotUploadDocs?.length;
    ...
    applicant1GenAppsCannotUploadDocs: {
      ...
      validator: (value, formData) => {
        const hasUploadedFiles =
          (formData.applicant1GenAppsEvidenceUploadedFiles as unknown as string[])?.length &&
          (formData.applicant1GenAppsEvidenceUploadedFiles as unknown as string) !== '[]';
        const selectedCannotUploadDocuments = !!formData.applicant1GenAppsCannotUploadDocs?.length;
        if (!hasUploadedFiles && !selectedCannotUploadDocuments) {
          return 'notUploaded';
        }
      ...
      values: [
        {
          name: 'applicant1GenAppsCannotUploadDocs',
          label: l => l.cannotUpload,
