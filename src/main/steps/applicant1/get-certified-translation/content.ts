...
const cy: typeof en = ({ isDivorce }) => ({
  ...
  } wedi’i hardystio a’i chyfieithu i Saesneg. Gallwch ddod o hyd i gwmnïau cyfieithu ar-lein sydd hefyd yn ardystio fel rhan o’u gwasanaeth.`,
  line2: `Pan fydd gennych eich tystysgrif ${
    isDivorce ? 'priodas' : 'partneriaeth sifil'
  } wedi’i chyfieithu a’i hardystio, yna dychwelwch i’r gwasanaeths hwn a pharhau â’ch cais. Gofynnir i chi lanlwytho llun ohoni’n ddiweddarach, neu ei phostio atom.`,
  line3:
