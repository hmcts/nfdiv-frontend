...
const cy: typeof en = (
  ...
  aosAwaitingOrDrafted: {
    line1: `${
      userCase.applicant1HelpPayingNeeded === YesOrNo.YES ? 'help with fees reference number ' : ''
    }Bydd eich cais yn cael ei wirio gan staff y llys. Fe gewch neges e-bost erbyn ${getFormattedDate(
      dayjs(userCase.dateSubmitted).add(config.get('dates.applicationSubmittedOffsetDays'), 'day'),
