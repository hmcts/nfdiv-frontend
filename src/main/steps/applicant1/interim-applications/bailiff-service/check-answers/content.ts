...
const cy: typeof en = (
  ...
  stepQuestions: {
    ...
    hasPartnerMadeThreats: `A yw eich ${partner} wedi gwneud unrhyw fygythiadau ar lafar neu ysgrifenedig yn eich erbyn chi, naill ai’n gyffredinol neu’n benodol mewn perthynas â’r ${isDivorce ? 'cais ysgariad' : 'cais i ddod â’r bartneriaeth sifil i ben'}?`,
