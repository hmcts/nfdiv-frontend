...
const en = (
  ...
  stepQuestions: {
    ...
    hasPartnerMadeThreats: `Has your ${partner} ever made verbal or written threats against you?`,
...
const cy: typeof en = (
  ...
  stepQuestions: {
    ...
    partnerEthnicGroup: `${capitalize(partner)}'s ethnic group`,
    partnerDistinguishingFeatures: `${capitalize(partner)}'s distinguishing features`,
    canUploadEvidence: `Are you able to upload a recent photo of your ${partner}?`,
    uploadedFiles: 'Uploaded photo',
    bestTimeToServePapers: `When is the best time for the bailiff to serve the papers to your ${partner}?`,
    doesPartnerHaveVehicle: `Does your ${partner} have a vehicle?`,
    partnerVehicleModel: `${capitalize(partner)}'s vehicle model`,
    partnerVehicleColour: `${capitalize(partner)}'s vehicle colour`,
    partnerVehicleRegistration: `${capitalize(partner)}'s vehicle registration`,
