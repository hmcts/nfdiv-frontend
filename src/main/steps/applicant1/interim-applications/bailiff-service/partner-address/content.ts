...
const en = ({ isApp2Confidential }: CommonContent, applicant2Address, updateEmailLinkPath) => ({
  ...
  line1: "Bailiff service can only be attempted at an address in England and Wales where postal delivery has already been tried.",
  ...
  homeAddress: "Address",
  partnerAddress: `${isApp2Confidential ? 'We have a confidential address for your partner. You can apply to attempt bailiff service at this address.' : applicant2Address}`,
});
