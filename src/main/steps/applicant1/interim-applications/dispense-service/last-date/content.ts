...
const en = ({ partner }: CommonContent) => ({
  title: `Did you and your ${partner} live together at any time during your relationship?`,
  subTitle: 'This includes any period you lived together, regardless of how long ago or how short the time was.',
  lastLivedTogether:
...
const cy = ({ partner }: CommonContent) => ({
  ...
  subTitle:
    "Mae hyn yn cynnwys unrhyw gyfnod y buoch chi'n byw gyda'ch gilydd, waeth pa mor bell yn ôl neu pa mor fyr oedd yr amser.",
  lastLivedTogether:
