...
const en = ({ isDivorce, partner }: CommonContent) => ({
  ...
  line2: `In most cases, you cannot ${
    isDivorce ? 'divorce your partner' : 'end your civil partnership'
  } without their knowledge. Therefore, dispensing with service is considered by the court to be a last resort.`,
