...
const en = ({ partner }: CommonContent) => ({
  ...
  line3: `If you know your ${partner} is living outside of the UK, you may wish to seek legal advice about how to legally serve the documents on your ${partner} in the country they're living in.`,
