...
const en = ({ isDivorce, partner }) => ({
  ...
  line3: `If you end this joint application then your ${partner} will be notified by email. If they still want to ${
  ...
  line4: 'If you are not sure what to do then you can save and sign out and get legal advice.',
