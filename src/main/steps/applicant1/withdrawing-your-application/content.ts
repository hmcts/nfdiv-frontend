...
const en = ({ isDivorce, partner }: CommonContent) => ({
  ...
  sole: {
    ...
    <a class="govuk-link" href="https://www.gov.uk/government/publications/form-d11-application-notice" target="_blank">D11 form</a>
  ...
  joint: {
    ...
    firstInTimeApplicant: `If you still want to ${
      ...
      <a class="govuk-link" href="https://www.gov.uk/government/publications/form-d84-application-for-a-decree-nisi-conditional-order-or-judicial-separation-decreeorder" target="_blank">download and fill out a D84 paper form.</a>
    ...
    secondInTimeApplicant: `Your ${partner} has already confirmed they want to continue with your joint application.
      ...
      <a class="govuk-link" href="https://www.gov.uk/government/publications/form-d84-application-for-a-decree-nisi-conditional-order-or-judicial-separation-decreeorder" target="_blank">downloading and filling out a D84 paper form.</a>
