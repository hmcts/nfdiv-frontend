...
const en = ({ partner, isDivorce }: CommonContent) => {
  ...
  return {
    title: `${separatingFrom} someone who lives outside of the UK`,
    line1: `The address you have provided for your ${partner} is outside of the UK. That means you are responsible for ‘serving’ (sending) the court documents, which notify your ${partner} about ${partnership}.`,
...
const cy: typeof en = ({ partner, isDivorce }: CommonContent) => {
  ...
  return {
    title: `${separatingFrom} rhywun sy’n byw y tu allan i'r DU`,
    line1: `Mae’r cyfeiriad rydych wedi’i ddarparu ar gyfer eich ${partner} y tu allan i'r DU. Mae hynny’n golygu eich bod chi’n gyfrifol am ‘gyflwyno’ (anfon) dogfennau’r llys, sydd yn hysbysu eich ${partner} am ${partnership}.`,
