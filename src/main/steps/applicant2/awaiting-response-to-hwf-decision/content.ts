...
const en = ({ partner }: CommonContent) => ({
  ...
  line2: `The Help With Fees application has been refused and the court will contact you on what you need to do to progress your application.`,
});
...
const cy: typeof en = ({ partner, userCase }: CommonContent) => ({
  ...
  line2: "Mae’r cais am Help i Dalu Ffioedd wedi’i wrthod a bydd y llys yn cysylltu â chi ynghylch beth sydd angen i chi ei wneud i barhau â’ch cais.",
});
