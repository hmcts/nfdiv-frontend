...
const en = ({ isDivorce, userCase }) => ({
  stepAnswers: {
    aboutPartnership: {
      line3: userCase.applicant2ScreenHasUnionBroken
    ...
    dividingAssets: {
      line1: userCase.applicant2ApplyForFinancialOrder
