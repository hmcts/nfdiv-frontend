...
const en = ({ applicant2 }: CommonContent) => ({
  ...
  line1: `It’s usually more straightforward and less expensive if you agree with your ${applicant2} on how to divide your savings, property, pensions and other assets. There are mediation services available to help you come to an agreement. You’ll be given links to more information after you have submitted this application.`,
  ...
  readMoreContent: `The court can only make financial orders for children under certain circumstances. You can come to an agreement with your ${applicant2} and make it legally binding with a consent order, or you can use the Child Maintenance Service.`,
  costs:
    'Applying to the court to make a financial order is done separately, using another form. It costs an additional £255.',
});

const cy: typeof en = ({ applicant2 }: CommonContent) => ({
  title: "Rhannu eich arian a'ch eiddo",
  line1: `Gan amlaf, mae'n symlach ac yn llai costus os ydych yn cytuno â'ch ${applicant2} ynghylch sut i rannu eich cynilion, eiddo, pensiynau ac asedau eraill. Mae yna wasanaethau cyfryngu ar gael i'ch helpu i ddod i gytundeb. Byddwch yn cael dolenni i ragor o wybodaeth ar ôl i chi gyflwyno'r cais hwn.`,
  ...
  readMoreContent: `Dim ond o dan rai amgylchiadau y gall y llys wneud gorchmynion ariannol i blant. Gallwch ddod i gytundeb â'ch ${applicant2} a'i wneud yn gyfreithiol rwymol gyda gorchymyn cydsynio, neu gallwch ddefnyddio'r Gwasanaeth Cynhaliaeth Plant.`,
  costs:
