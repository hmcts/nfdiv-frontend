...
const en = ({ partner, isDivorce, required }) => ({
  ...
  line1: `It’s important you provide your ${partner}'s address. You did not provide their email address and the court needs a way to ‘serve’ (deliver) the ${
...
const cy: typeof en = ({ partner, isDivorce, required }) => ({ ...en({ partner, isDivorce, required }) });
