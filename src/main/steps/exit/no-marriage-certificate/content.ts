...
const civilEn = {
  ...
  ask:
    'ou should ask your civil partner for it, if they have it. Or you can <a href="https://www.gov.uk/order-copy-birth-death-marriage-certificate" class="govuk-link" target="_blank">order a certified copy online (opens in a new tab)</a> if you formed your civil partnership in England or Wales.',
  certificateTranslation:
...
export const noMarriageCertificateContent = {
  divorce: {
    en: divorceEn,
    cy: divorceCy,
  },
