...
const en = ({ isDivorce, applicant2 }: CommonContent) => ({
  ...
  } on your own (as a ‘sole applicant’) or with your ${applicant2} (in a ‘joint application’).`,
  subHeading1: 'Applying as a sole applicant',
  line2: `If you apply as a sole applicant, your ${applicant2} responds to your ${
    isDivorce ? 'divorce application' : 'application to end your civil partnership'
  } after you have submitted it. You will be applying on your own.`,
  subHeading2: `Applying jointly, with your ${applicant2}`,
  line3: `If you apply jointly, your ${applicant2} joins and reviews this online application before it’s submitted. You will be applying together.`,
  line4:
  ...
  helpText1: `This ${
    isDivorce ? 'divorce application' : 'application to end your civil partnership'
  } costs £550. In a sole application you will have to pay the divorce fee. In a joint application, either you or your ${applicant2} will be able to pay. The payment system does not allow you to split the payment.`,
  ...
  helpText3: `In a sole application, only you have to be eligible and claim help with fees. In a joint application, both you and your ${applicant2} have to be eligible and claim help with fees separately.`,
  soleApplication: 'I want to apply on my own, as a sole applicant',
  jointApplication: `I want to apply jointly, with my ${applicant2}`,
  errors: {
    applicationType: {
