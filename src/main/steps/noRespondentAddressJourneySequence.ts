...
export const noRespondentAddressJourneySequence: Step[] = [
  ...
  {
    url: NO_RESP_ADDRESS_INTERNATIONAL_ADDRESS,
    getNextStep: (): PageLink => NO_RESP_ADDRESS_ENTER_EMAIL,
  },
  {
    url: NO_RESP_ADDRESS_ENTER_EMAIL,
    getNextStep: (): PageLink => NO_RESP_ADDRESS_CHECK_ANSWERS_ADDRESS,
  },
  {
    url: NO_RESP_ADDRESS_CHECK_ANSWERS_ADDRESS,
    getNextStep: (): PageLink => NO_RESP_ADDRESS_DETAILS_UPDATED,
  },
  {
