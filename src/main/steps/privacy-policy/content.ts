const en = {
  ...
  moj:
    "The MoJ is known as the data controller for data protection purposes. <a class='govuk-link' href='https://www.gov.uk/government/organisations/ministry-of-justice/about/personal-information-charter' target='_blank'>MoJ personal information charter</a> explains how the MoJ processes personal data.",
  responsibleRorDeciding:
  ...
  applicantAndRespNames: 'the applicant’s and respondent’s current names',
  changedName: 'proof of the applicant’s name change if they’ve changed it since they got married',
  marriageCert: 'a copy of the marriage certificate and the details from it',
  countryInMarried: 'the country in which the applicant and respondent are habitually resident',
  yourHabitualResidence: 'whether the applicant and respondent are habitually resident in England or Wales',
  yourDomicile: 'whether the applicant’s and respondent’s domicile is in England or Wales',
  emailAndPhone: 'applicant’s and respondent’s addresses, email addresses and phone numbers',
  addressAndNames: 'addresses and names of the applicant’s and respondent’s solicitors (if they have them)',
  reasonsForDivorce: 'details around the reason for the divorce',
  otherCourtCases: 'details of other court cases the applicant and respondent have been involved in',
  adulteryNames:
...
const cy: typeof en = {
  ...
  info:
    'Mae’r polisi preifatrwydd hwn yn egluro pam rydym yn casglu eich data personol a sut rydym yn ei ddefnyddio. Mae hefyd yn egluro eich hawliau a sut i’w gorfodi.',
  whoManages: 'Pwy sy’n rheoli’r gwasanaeth hwn?',
  managedBy:
    'Gwasanaeth Llysoedd a Thribiwnlysoedd EM (GLlTEM), un o asiantaethau gweithredol y Weinyddiaeth Gyfiawnder (MoJ), sy’n rheoli’r gwasanaeth hwn.',
  moj:
    "MoJ yw’r rheolydd data i ddibenion diogelu data. <a class='govuk-link' href='https://www.gov.uk/government/organisations/ministry-of-justice/about/personal-information-charter' target='_blank' >Mae siarter gwybodaeth bersonol yr MoJ</a> yn egluro sut mae’r MoJ yn prosesu data personol.",
  responsibleRorDeciding:
    'Fel rhan o’r MoJ, mae GLlTEM yn gyfrifol am benderfynu sut mae eich data personol yn cael ei ddefnyddio ac mae’n gyfrifol am ddiogelu’r data personol yr ydych yn ei ddarparu.',
  moreInformation:
  ...
  weMayAskForPermission:
    'Byddwn yn gofyn am eich caniatâd i ddefnyddio eich cyfeiriad e-bost i anfon negeseuon e-bost atoch trwy’r system GOV.UK Notify. O fewn Ardal Economaidd Ewrop yn unig mae’r system hon yn prosesu negeseuon e-bost hyd nes y’u trosglwyddir i’r darparwr e-bost rydych chi’n ei ddefnyddio. ',
  weUseCookies:
  ...
  yourComputer: 'cyfeiriad IP eich cyfrifiadur, eich ffôn neu eich tabled',
  theRegion: 'yr ardal neu’r dref lle rydych yn defnyddio’ch cyfrifiadur, eich ffôn neu eich tabled',
  theWeb: 'y porwr gwe rydych yn ei ddefnyddio',
  sharingYour: 'Rhannu eich data',
  ifAnother:
    'Pan fydd eich cais yn cael ei brosesu, mae’n bosib y byddwn angen cysylltu ag adran, asiantaeth neu sefydliad arall yn y llywodraeth ac efallai y byddwn yn rhannu eich data gyda nhw.',
  dataSharedWithPrintingServiceProvider:
    'Rhennir unrhyw ddata a ddarperir gennych y mae angen ei argraffu gyda Xerox (UK) Ltd. Er enghraifft , argreffir y cais am ysgariad fel y gellir ei anfon at yr atebydd drwy’r post.',
  ifYouContactUs:
  ...
  crime:
    'Mewn rhai amgylchiadau efallai y byddwn yn rhannu eich data, er enghraifft, er mwyn atal trosedd, dal troseddwyr neu gynhyrchu data dienw.',
  weUse:
    "Rydym yn defnyddio Google Analytics i gasglu data am y defnydd o’r wefan. Mae’r data dienw hwn yn cael ei rannu â Google. Mae rhagor o wybodaeth am hyn yn ein <a class='govuk-link' href='terms-and-conditions' >telerau ac amodau</a>.",
  storeAndShare: 'Storio a rhannu eich data’n rhyngwladol',
  personalInformation:
    'Weithiau efallai y bydd angen inni anfon eich gwybodaeth bersonol tu allan i’r DU. Pan fyddwn yn gwneud hyn byddwn yn cydymffurfio â chyfreithiau diogelu data.',
  yourRights: 'Eich hawliau',
  youCanAsk: 'Gallwch ofyn:',
  toSeePersonal: 'am gael gweld y data personol rydym yn ei gadw amdanoch',
  toHavePersonal: 'inni gywiro’r data personol',
  toHaveDataRemoved:
    'inni symud neu ddileu’r data personol (bydd hyn yn ddibynnol ar yr amgylchiadau, er enghraifft os ydych chi’n penderfynu peidio â pharhau gyda’ch cais)',
  thatAccessIsRestricted:
    'inni gyfyngu ar y mynediad at y data personol (er enghraifft, gallwch ofyn inni storio’r data am gyfnod hirach a pheidio â’i dileu’n awtomatig)',
  ifYouWantToSeePersonal: 'Os ydych eisiau gweld y data personol rydym yn ei gadw amdanoch, gallwch:',
  completeForm:
    "lenwi ffurflen i wneud <a class='govuk-link' href='https://www.gov.uk/government/publications/request-your-personal-data-from-moj' target='_blank' >cais gwrthrych am wybodaeth</a> - bydd y cais hwn yn mynd i’r rheolydd data, sef MoJ",
  writeToUs: 'ysgrifennu atom: Disclosure Team, Post point 10.38, 102 Petty France, Llundain, SW1H 9AJ',
  askMoreInformation: 'Gallwch ofyn am ragor o wybodaeth am:',
  ...
  whenYouUseDivorceService: 'Mae arnom angen y data personol a ganlyn ar gyfer y gwasanaeth hwn:',
  applicantAndRespNames: 'Enwau cyfredol y ceisydd a’r atebydd',
  changedName: 'Tystiolaeth o newid enw’r ceisydd os yw wedi newid ei enw ers priodi',
  marriageCert: 'Copi o’r dystysgrif briodas a’r manylion sydd ynddi',
  countryInMarried: 'Y wlad y mae’r ceisydd a’r atebydd yn preswylio ynddi’n arferol',
  yourHabitualResidence: 'A yw’r ceisydd a’r atebydd yn preswylio’n arferol yng Nghymru neu Loegr ai peidio?',
  yourDomicile: 'A yw’r ceisydd a’r atebydd â’u domisil yng Nghymru neu Loegr ai peidio?',
  emailAndPhone: 'Cyfeiriadau, cyfeiriadau e-bost a rhifau ffôn y ceisydd a’r atebydd',
  addressAndNames: 'Cyfeiriadau ac enwau cyfreithwyr y ceisydd a’r atebydd (os oes ganddynt gyfreithwyr)',
  reasonsForDivorce: 'Manylion ynglŷn â’r rheswm dros ysgaru',
  otherCourtCases: 'Manylion achosion llys eraill y bu a wnelo’r ceisydd a’r atebydd â hwy',
  adulteryNames:
    'Enw a chyfeiriad yr unigolyn yr honnir bod yr atebydd wedi godinebu ag ef/hi (dewisol ac ni ofynnir y cwestiwn ond pan ddywedir mai godineb yw’r rheswm dros ysgaru)',
  receivingNotifications: 'Derbyn hysbysiadau',
  youNeedSignUp:
    'Mae angen ichi gofrestru i dderbyn hysbysiadau i ddefnyddio’r gwasanaeth ysgaru. Mae hwn yn ofyniad cyfreithiol er mwyn i’r cais am ysgariad fynd yn ei flaen.',
  askedForEmailAddress:
    'Pan fyddwch yn defnyddio’r gwasanaeth hwn gofynnir ichi ddefnyddio’ch cyfeiriad e-bost i greu cyfrif. Byddwch yn gallu defnyddio’r neges e-bost hwn a chyfrinair i fewngofnodi i wasanaethau eraill GLlTEM.',
  holdYourData:
    'Tra byddwch yn llenwi cais am ysgariad neu’n ymateb i gais, byddwn yn cadw eich data am hyd at 6 mis. Os na fyddwch yn cwblhau’r cais yn ystod yr amser hwn, bydd yn rhaid ichi ddechrau eto.',
  whenADivorceIsFinalised:
    'Pan gwblheir ysgariad cedwir yr achos am 18 mlynedd. Ar ôl y cyfnod hwnnw, dilëir peth data (o’r dyfarniad nisi a’r dyfarniad absoliwt).',
  theRemainder:
    'Cedwir gweddill gwybodaeth yr achos am 82 blynedd arall. Wedi cyfanswm o 100 mlynedd dileir y data hwnnw.',
  thePersonal: 'Y data personol mae arnom ei angen',
  storingYourData: 'Storio eich data',
};

export const privacyPolicyContent = { en, cy, common: {} };
