...
const en = ({ isDivorce, partner }: CommonContent) => ({
  ...
  }. You will also need to pay an application fee of [£167], unless you are eligible for Help With Fees. Your application for a final order will then be reviewed by a judge. You may have to come to a court hearing.`,
