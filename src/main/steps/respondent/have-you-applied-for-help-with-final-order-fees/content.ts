...
const en = ({ required }) => ({
  title: 'Have you already applied for help with your final order application fee?',
  ...
  errors: {
    applicant2FoAlreadyAppliedForHelpPaying: {
      required,
    },
...
const cy: typeof en = ({ required }) => ({
  title: 'A ydych chi eisoes wedi gwneud cais am help i dalu ffi eich cais am orchymyn terfynol?',
  ...
  errors: {
    applicant2FoAlreadyAppliedForHelpPaying: { required },
    applicant2FoHelpWithFeesRefNo: {
      required:
