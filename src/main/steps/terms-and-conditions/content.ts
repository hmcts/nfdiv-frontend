...
const en = {
  ...
  answer: 'You should answer the questions in the service based on your  circumstances, and seek legal advice if you need it.',
  stored: 'Where your data is stored',
  data: 'Your data will be stored in data centres in the UK.',
  notifyEmails: 'We use GOV.UK Notify to send emails. Until the point where emails are handed over to your email provider, they are processed within the EEA. Your data is stored for 1 month, and is deleted after this.',
  applicationLaw: 'Applicable law',
  dispute: 'Your use of this service and any dispute arising from its use will be  governed by and construed in accordance with the laws of England and Wales, including but not limited to the:',
  ...
  designedForPeople: 'The service is designed for people who need to use it or by others on their behalf and only with their consent.',
  risks: 'There are risks in using a shared computer (for example in an internet café) to access this service. It’s your responsibility to be aware of these risks and to avoid using any computer which may leave your personal information accessible to others. You’re responsible if you choose to leave a computer unprotected while using this service.',
...
const cy: typeof en = {
  ...
  thisPage: 'Mae’r dudalen hon yn egluro telerau defnyddio’r gwasanaeth hwn. Ar y wefan hon maent yn cynnwys <a class="govuk-link" href="https://www.gov.uk/help/privacy-policy" target="_blank">polisi preifatrwydd</a> and <a class="govuk-link" href="https://www.gov.uk/help/terms-conditions" target="_blank">telerau ac amodau</a>. Trwy ddefnyddio’r gwasanaeth hwn rydych yn cytuno i’r polisi preifatrwydd a’r telerau a’r amodau.',
  whoWeAre: 'Pwy ydym ni?',
  managedBy: 'Rheolir y gwasanaeth hwn gan Wasanaeth Llysoedd a Thribiwnlysoedd Ei Mawrhydi a chyfeirir at y gwasanaeth o hyn ymlaen fel ‘ni’.',
  update: 'Efallai y byddwn yn diweddaru’r telerau a’r amodau hyn os bydd newid yn y gyfraith neu newid i’r ffordd mae’r gwasanaeth yn gweithio.',
  info: 'Gwybodaeth a ddarperir gan y gwasanaeth hwn',
  service: 'Mae’r gwasanaeth hwn yn darparu gwybodaeth i’ch cefnogi. Ni allwn roi cyngor cyfreithiol ar achosion unigol.',
  answer: 'Dylech ateb y cwestiynau yn seiliedig ar eich amgylchiadau a cheisio cyngor cyfreithiol os oes arnoch angen hynny.',
  stored: 'Ble mae eich data’n cael ei storio?',
  data: 'Bydd yr holl ddata personol yn cael ei storio ar weinyddion diogel yn y DU.',
  notifyEmails: 'Rydym yn defnyddio GOV.UK Notify i anfon e-byst. Nes y trosglwyddir e-byst i’ch darparwr e-bost, fe’u prosesir yn yr EEA. Cedwir eich data am 1 mis, ac fe’i dileir ar ôl hynny.',
  applicationLaw: 'Y gyfraith sy’n berthnasol',
  dispute: 'Bydd y defnydd a wnewch o’r gwasanaeth hwn ac unrhyw anghydfod sy’n codi o’i ddefnyddio yn cael eu rheoli a’u dehongli yn unol â chyfreithiau Cymru a Lloegr, gan gynnwys, ond heb fod yn gyfyngedig i’r canlynol:',
  ...
  designedForPeople: 'Cynlluniwyd y gwasanaeth ar gyfer pobl sydd angen ei ddefnyddio neu bobl sy’n ei ddefnyddio ar ran eraill gyda’u cydsyniad.',
  ...
  precautions: 'Mae’n rhaid ichi gymryd camau priodol eich hun i sicrhau nad yw’r ffordd rydych yn cael mynediad at y gwasanaeth hwn yn eich gadael yn agored i’r peryglon hyn:',
  ...
  knowinglyIntroducing: 'Ni ddylech gamddefnyddio’r gwasanaeth hwn drwy fynd ati’n fwriadol i gyflwyno firysau, trojans, worms, logic bombs neu unrhyw ddeunydd arall maleisus neu sy’n niweidiol i dechnoleg. Ni ddylech geisio cael mynediad heb awdurdod at y gwasanaeth hwn, y system lle caiff ei storio nac unrhyw weinydd, cyfrifiadur neu gronfa ddata sy’n gysylltiedig â’r gwasanaeth. Ni ddylech ymosod ar y wefan hon drwy ymosodiad gwrthod gwasanaeth neu ymosodiad gwrthod gwasanaeth a ddosbarthwyd.',
  containsSeveral: 'Mae’r gwasanaeth ar-lein hwn yn cynnwys meysydd testun rhydd lle bydd gofyn ichi nodi mathau penodol o wybodaeth. Ni ddylid rhoi gwybodaeth sensitif yn y rhannau hyn. Gall data sensitif gynnwys manylion credoau crefyddol a data ariannol ymysg pethau eraill. Chi sy’n gyfrifol am unrhyw ddata sensitif yr ydych yn ei darparu.',
  changes: 'Newidiadau i’r telerau a’r amodau hyn',
  checkTermsAndConditions: 'Dylech wirio’r telerau a’r amodau hyn yn rheolaidd. Efallai y byddwn yn eu diweddaru ar unrhyw adeg heb rybudd.',
  agreeToChanges: 'Rydych yn cytuno i unrhyw newidiadau drwy barhau i ddefnyddio’r gwasanaeth hwn ar ôl diweddaru’r telerau a’r amodau hyn.',
  contactUs: 'Cysylltwch â ni',
  address: 'Uned yr Iaith Gymraeg, Canolfan Gyfiawnder Caernarfon<br>Ffordd Llanberis<br>Caernarfon<br>Gwynedd<br>LL55 2DF<br>'
};
