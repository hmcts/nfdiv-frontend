...
export const ENTER_YOUR_ADDRESS_APPLICANT2: PageLink = `${APPLICANT_2}${ENTER_YOUR_ADDRESS}`;
export const OTHER_COURT_CASES_APPLICANT2: PageLink = `${APPLICANT_2}${OTHER_COURT_CASES}`;
