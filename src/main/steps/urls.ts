...
export const JURISDICTION_HABITUALLY_RESIDENT: PageLink = '/habitually-resident-england-wales';
export const JURISDICTION_LIVING_HERE_FOR_6_MONTHS: PageLink = '/living-england-wales-six-months';
