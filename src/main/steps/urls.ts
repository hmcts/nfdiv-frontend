...
export const SAVE_AND_SIGN_OUT: PageLink = '/save-sign-out';
...
export const MAKE_AN_OFFLINE_APPLICATION: PageLink =
  '/interim-applications/general-application/make-an-offline-application';
