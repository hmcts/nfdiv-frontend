...
const en = ({ relationship, isDivorce, applicant2, civilPartner }) => ({
  ...
  line2: `You should ask your ${
    isDivorce ? applicant2 : civilPartner
...
const cy: typeof en = ({ relationship, isDivorce, applicant2, civilPartner }) => ({
