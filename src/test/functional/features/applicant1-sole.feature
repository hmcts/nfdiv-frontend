Feature: Applicant 1 joint application
  ...
  Scenario: They fill out a happy path applicant 1 sole journey
    ...
    Then the page URL should be "/date-from-certificate"
    ...
    And the page should include "How do you want to apply for the divorce?"
    ...
    And the page should include "You can use English or Welsh courts to get a divorce"
    When I click "Continue"
    Then the page URL should be "/enter-your-name"
    ...
    And I type "Smith"
    And I click "Continue"
    Then the page URL should be "/enter-their-name"
    ...
    And I type "Bob"
    When I click "Continue"
    Then the page URL should be "/your-names-on-certificate"
    And the page should include "Your names on your marriage certificate"
    ...
    When I click "Continue"
    Then the page URL should be "/changes-to-your-name"
    ...
    And the page should include "Do you need your contact details kept private from your husband?"
    ...
    And the page should include "Enter your husband’s postal address"
    Given I select "Enter a UK postcode"
    And I type "SW1H 9AJ"
    When I click "Find address"
    Then the page should include "SW1H 9AJ"
  ...
  Scenario: They fill out an unhappy path applicant 1 sole journey with help with fees
    ...
    When I click "Continue"
    Then the page URL should be "/relationship-not-broken"
    ...
    When I click "Continue"
    Then the page URL should be "/you-need-your-certificate"
    And the page should include "You need your marriage certificate"
    Given I click "Back"
    Then the page URL should be "/do-you-have-your-certificate"
    Given I select "Yes, I have my marriage certificate"
    When I click "Continue"
    ...
    Given I select "No"
    When I click "Continue"
    Then the page URL should be "/apply-for-help-with-fees"
    ...
    Given I select "No"
    When I click "Continue"
    Then the page URL should be "/certificate-in-english"
    And the page should include "Is your original marriage certificate in English?"
    Given I select "No"
    When I click "Continue"
    ...
    When I click "Continue"
    Then the page URL should be "/get-certified-translation"
    And the page should include "You need to get a ‘certified translation’ of your marriage certificate"
    Given I click "Back"
    Then the page URL should be "/certified-translation"
    Given I select "Yes, I have a certified translation"
    When I click "Continue"
    Then the page URL should be "/country-and-place"
    ...
    And the page should include "You need to get their address"
    ...
    And the page should include "How to apply to serve (deliver) the papers another way"
    When I click "Continue"
    Then the page URL should be "/other-court-cases"
    And the page should include "Other court cases relating to this marriage"
    Given I select "Yes"
