Feature: Final order
  ...
  Scenario: Applicant sole final order journey after a year
    Given a superuser updates "dateFinalOrderNoLongerEligible" with "2021-05-05"
    When I go to "/"
    ...
    Then the page should include "Explain the delay"
    ...
    And I type "Test delay info details"
