Feature: Form failures
  ...
  Scenario: They fail to fill out the applicant 2 forms
    ...
    Scenario: They fail to fill out joint conditional order questions
      ...
      Given I select "No"
      When I click "Continue"
      Then the page should include "You have said the information is not still correct but not provided details. Provide details of what information is not correct."
      Given I select "Yes"
      When I click "Continue"
      ...
      Given I set the case state to "ConditionalOrderPending"
      When I go to "/"
