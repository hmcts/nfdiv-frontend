Feature: Respondent
  ...
  Scenario: They fail to fill out the respondent forms
    ...
    And I click "Submit"
    Then the page should include "There was a problem"
    And the page should include "You have not confirmed that you are the respondent and that you believe the facts in the application are true. You need to confirm before continuing."
