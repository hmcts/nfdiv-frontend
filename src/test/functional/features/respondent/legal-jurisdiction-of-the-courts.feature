Feature: Respondent Legal Jurisdiction of the Courts 
  ...
  Scenario: Agree that the courts of England and Wales have jurisdiction
    Given I clear the form
    And I select "Yes, I agree the courts have jurisdiction"
    When I click "Continue"
  ...
  Scenario: Disagree that the courts of England and Wales have jurisdiction
    ...
    Then the page should include "Explain why you think the courts of England and Wales do not have the legal power (jurisdiction) to grant your divorce"
