Feature: Sole application journey
  ...
  Scenario: They fill out a happy path sole journey
    # Applicant 1
  ...
  @nightly
  Scenario: They fill out a unhappy path sole journey with help with fees
    # Applicant 1
    Given I select "My husband"
